...
![Log(detctions/Night) for each of the three species. Largest estimated effects are difficult to see, but present in Michigan mitten - blank points are water](./images/three_species_model/log_detections_national.png)
