...
- Instead of using (latitude, longitude) as spatial coordinates, use (latitude, distance to water)
...
## Three-Species Linear Model - Specification
- Fit a linear model (LM) with the following covariates:
    - Latitude, Longitude
    - Distance to and size of nearest water body
    - Species
    
\begin{align*}
  Y_i &\sim X_i^\top \beta + \epsilon_i \\ 
  \epsilon_i &\sim N(0, \sigma^2)
\end{align*}
    
## Three-Species Linear Model - Residuals
![](./images/linear_model_residuals.png){fig-align="center"}
    
## Three-Species Spatial Linear Model
...
## Three-Species Spatial Linear Model - Specification
...
Our covariates are (1) Species, (2) Longitude, (3) Size of Nearest Water Body.
